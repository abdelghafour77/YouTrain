...
<nav class="navbar fixed-top navbar-light bg-light">
  <div class="container-fluid">
    <span>
   <span><a class="" href="#" style="color:black;"><img class="nav-item-icon" src="../code\assets\img\logo.webp" width="30" height="30" alt="navIcon"></span></a>
                                                             ...
                                                             <div class="px-5 mt-5"> 
                                                                <div class="inputbox"> 
                                                                    ...
                                                                    <div class="pay px-5"> 
                                                                        ...
                                                                        <button type="button" class="close btn btn-primary btn-block" data-dismiss="modal" aria-label="Close">Close</button>
